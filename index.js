 ...
 * @author : Thenuka bot <https://github.com/Thenukadilitha>
 * @description : A Multi-functional whatsapp bot script.
 * @version 3.0.0
 **/
const express = require("express");
const app = express();
app.get("/", (req, res) => res.send("Thenuka-MD Running on Koyeb 24/7!"));
...
const ownerNumber = ['94760410611']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to Thenuka-session- env !!')
const sessdata = config.SESSION_ID.replace("THENUKA-MD~", '');
...
console.log("CONNECTING THENUKA-MD 🧬...");
...
console.log('THENUKA MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ THENUKA-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
if(senderNumber.includes("94760410611")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, THENUKA-MD STARTED ✅");
});
